...
| Import runs but imports 0 jobs | Check **Categories** has job titles configured; TheirStack's title match is an OR filter, so results outside your configured titles are intentionally skipped and logged. |
